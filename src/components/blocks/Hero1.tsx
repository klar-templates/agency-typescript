export default function Hero1(data: any) {
  ...
  return (
    <div className="text-on-background relative isolate bg-white border-t h-scree g-[url('https://raw.githubusercontent.com/klar-templates/agency/master/img/header-bg.jpg')]">
          ...
          <div className="mx-auto max-w-3xl px-16 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div>
                ...
                <p className="text-on-surface mt-6 text-lg leading-8 sm:text-center">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
