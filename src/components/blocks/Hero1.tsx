export default function Hero1(data: any) {
  ...
  return (
    <div className="text-on-background ext-inverse-on-surface relative isolate bg-white order-t">
      <div className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl m:top-[-20rem]">
      ...
      <main className="relative z-10">
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl px-16 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div>
                ...
                <p className="text-on-surface ext-inverse-on-surface mt-6 text-lg leading-8 sm:text-center">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  <a href="#" className="text-inverse-on-surface inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
                    Get started
