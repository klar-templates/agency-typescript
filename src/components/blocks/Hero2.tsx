      ...
      <div className="relative mx-auto container px-4 pt-16 sm:px-0 lg:pt-20">
        <div className="mx-auto grid max-w-[40rem] grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-3">
          <div className="flex flex-col lg:pb-6">
            ...
            <p className="order-first text-base font-semibold leading-7 text-sky-500">Podcast template</p>
            <p className="mt-6 text-base leading-7 text-slate-700">You’ve ordered your SM7B, boom arm, and a bunch of acoustic foam. With this template, you can finally stop procrastinating and record your first episode.</p>
